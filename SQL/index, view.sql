...
-- 뷰는 물리적인 저장 공간이 존재하지 않기 때문에
-- INSERT, UPDATE, DELETE 및 INDEX 생성이 불가능

-- 테이블 접근 및 칼럼 권한에 대한 제어를 쉽게 할 수 있음
...
-- GRANT SELECT ON shool.teacher_summary TO 'user'@'hostname';

-- view 수정
-- ALTER VIEW 이름 AS 조회문 ~
