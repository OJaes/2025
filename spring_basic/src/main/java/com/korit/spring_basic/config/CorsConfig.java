...
// Cors 정책 : Cross origin Resource Sharing으로 웹 브라우저의 스크립트로 출처가 서로 다른 곳으로 자원을 공유할 때 지정하는 정책
...
public class CorsConfig implements WebMvcConfigurer{
    ...
    // cors 정책 설정 변경할 수 있는 메서드
    @Override
    public void addCorsMappings(CorsRegistry corsRegistry){
        corsRegistry
        //  addMapping() : 특정 url 패턴에 대하여 지정
        .addMapping("/**") // 전체 패턴 : /**
        // allowedOrigins() : 허용할 출처를 지정
        .allowedOrigins("*") // 전체 출처 : *
