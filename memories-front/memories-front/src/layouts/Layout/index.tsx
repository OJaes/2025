...
import {
    ACCESS_TOKEN,
    AUTH_ABSOLUTE_PATH,
    CONCENTRATION_TEST_ABSOLUTE_PATH,
    DIARY_ABSOLUTE_PATH,
    MAIN_ABSOLUTE_PATH,
    MEMORY_TEST_ABSOLUTE_PATH,
    ROOT_PATH,
} from 'src/constants';
...
export default function Layout() {
    ...
    // variable: 기억력 검사 클래스 //
    const memoryTestClass = pathname.startsWith(MEMORY_TEST_ABSOLUTE_PATH)
        ...
        <div id="layout-wrapper">
            <div id="top-bar">
                <div className="navigation">
                    <div className="title" onClick={onHomeClickHandler}>
                        Memories
                    </div>
                    <div className="navigation-list">
                        <div className={memoryTestClass} onClick={onMemoryTestClickHandler}>
                            기억력 검사
                        </div>
                        <div className={concentrationTestClass} onClick={onConcentrationTestClickHandler}>
                            집중력 검사
                        </div>
                    </div>
                </div>
                <div className="my-content" onClick={onMyContentClickHandler}>
                    {showMyContent && (
                        <div ref={myContentListRef} className="my-content-list">
                            <div className="my-content-item" onClick={onDiaryClickHandler}>
                                일기
                            </div>
                            <div className="my-content-item" onClick={onSignOutClickHandler}>
                                로그아웃
                            </div>
                        </div>
                    )}
