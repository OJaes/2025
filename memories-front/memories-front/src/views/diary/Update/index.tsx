...
import { GetDiaryResponseDto, GetMyDiaryResponseDto } from 'src/apis/dto/response/diary';
            ...
            <div className="update-container">
                ...
                <div className="contents-container">
                    ...
                    <div className="input-row-box">
                        ...
                        <div
                            className={happyContentClass}
                            onClick={() => {
                                onFeelingChangeHandler('행복');
                            }}
                        >
                            <div className={happyIconClass}></div>행복
                        </div>
                        <div
                            className={funnyContentClass}
                            onClick={() => {
                                onFeelingChangeHandler('즐거움');
                            }}
                        >
                            <div className={funnyIconClass}></div>즐거움
                        </div>
                        <div
                            className={normalContentClass}
                            onClick={() => {
                                onFeelingChangeHandler('보통');
                            }}
                        >
                            <div className={normalIconClass}></div>보통
                        </div>
                        <div
                            className={sadContentClass}
                            onClick={() => {
                                onFeelingChangeHandler('슬픔');
                            }}
                        >
                            <div className={sadContentClass}></div>슬픔
                        </div>
                        <div
                            className={angryContentClass}
                            onClick={() => {
                                onFeelingChangeHandler('분노');
                            }}
                        >
                    ...
                    <div className="input-column-box">
                        ...
                        <input placeholder="제목을 입력하세요" value={title} onChange={onTitleChangeHandler} />
                    </div>
                    <div className="input-column-box">
                        <div className="title">내용</div>
                        {content !== '' && <TextEditor content={content} setContent={onContentChangeHandler} />}
                    </div>
