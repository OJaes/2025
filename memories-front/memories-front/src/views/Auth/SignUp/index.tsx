        ...
        <div id="auth-sign-up-container">
            ...
            <div className="input-container">
                ...
                <InputBox
                    ...
                    buttonName={'주소 검색'}
                    onButtonClick={onSearchAddressClickHandler}
                    isErrorMessage
                    isButtonActive
                    readOnly
                />
                ...
                <InputBox
                    ...
                    onChange={onUserDetailAddressChangeHandler}
                    message={''}
                />
            </div>
            <div className="button-container">
                ...
                <div className="link" onClick={() => onPageChange('sign-in')}>
                    로그인
                </div>
            </div>
        </div>
