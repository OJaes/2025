...
// 상대, 절대를 나누는 이유는 파일 경로 수정 시 생길 문제를 예방하기 위함함
// variable: 절대 path 상수 //
...
export const DIARY_UPDATE_ABSOLUTE_PATH = (diaryNumber: number | string) =>
    `${ROOT_PATH}${DIARY_PATH}/${diaryNumber}/${DIARY_UPDATE_PATH}`;
